...
const Navbar = ({sidebarToggle,setSideBarToggle}) => {
  return (
    <nav className='bg-violet-900 px-4 py-3 flex justify-between '>
      <div className='flex items-center text-xl'>
        <FaBars className='text-white me-4 cursor-pointer' onClick={() => setSideBarToggle(!sidebarToggle)}/>
        <span className='text-white font-semibold'>EVzone</span>
      </div>
        ...
        <div className='relative'>
          <button className='text-white group'>
            ...
            <div className='z-10 hidden absolute bg-white rounded-lg shadow w-32  group-focus:block top-full right-0'>
              <ul className='py-2 text-sm bg-slate-600 rounded text-white'>
